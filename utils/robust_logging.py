...
class PerformanceMetrics:
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        with self._lock:
            ...
            cache_rate = (self._metrics['cache_hits'] / total_cache * 100) if total_cache > 0 else 0
...
class RobustLogger:
    ...
    def _setup_root_logger(self):
        ...
        if self.config['enable_json']:
            ...
            json_formatter = JSONFormatter(include_metrics=self.config['enable_metrics'])
    ...
    def export_logs_report(self, output_path: str):
        ...
        report = {
            ...
            'log_files': {
                ...
                'json': str(Path(self.config['log_dir']) / self.config['json_filename'])
            }
        }
