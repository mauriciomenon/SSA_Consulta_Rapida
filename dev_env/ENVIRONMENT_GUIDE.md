...
- `scripts/env/direnv_common.sh`: nucleo compartilhado. Resolve a variante (`stable` ou `free-threaded`), provisiona pyenv ou `.venv` e exporta PATH/vari?veis.
...
- `pyenv version` / `pyenv virtualenvs`: lista vers?es disponiveis.
