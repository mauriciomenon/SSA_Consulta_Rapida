...
print('Termos: ["nan"]')
print(f'Resultados: {len(result)} linhas')
print('Esperado: 0 linhas (NaN nao deve ser encontrado como "nan")')
if len(result) == 0:
    print('Status: PASS')
else:
    print('Status: FAIL')
...
print('Termos: ["sistema", "TI"]')
print(f'Resultados: {len(result)} linhas')
print('Esperado: 2 linhas (ambos termos presentes)')
if len(result) == 2:
    print('Status: PASS')
else:
    print('Status: FAIL')
...
print(f'Resultados: {len(result)} linhas')
print('Esperado: 2 linhas (cache deve funcionar)')
if len(result) == 2:
    print('Status: PASS')
else:
    print('Status: FAIL')
