...
from PyQt6.QtWidgets import QApplication, QLabel, QLineEdit, QPushButton  # noqa: E402
...
class TestGUIFilterLogic:
    ...
    @pytest.mark.skip(
        reason="clear_filter() now only clears search_input, not all filters; test expects full reset"
    )
