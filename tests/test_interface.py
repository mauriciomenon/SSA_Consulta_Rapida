...
def test_filter_dataframe_single_term():
    ...
    data = {
        "col_texto": [
            "Relatório sobre o servidor A",
            "Análise do sistema B",
            "Servidor C com problemas",
        ],
        "col_num": [10, 20, 30],
    }
...
def test_filter_dataframe_multiple_terms():
    ...
    data = {
        "descricao_ssa": [
            "Falha no painel do servidor CISCO",
            "Servidor CISCO está OK",
            "Problema no painel de rede",
        ],
