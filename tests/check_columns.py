...
colunas_novas = ['registros_espera', 'num_reprobaciones', 'situacao_espera', 'numero_desvios', 'ate', 'justificativa', 'total_tempo_tex_executada', 'parciais', 'situacao_da_parcial']
