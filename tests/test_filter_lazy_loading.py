...
class TestFilterLazyLoadingMethods:
    ...
    def test_update_multiselect_button_has_suffix_param(self):
        ...
        assert 'suffix' in params, "Parametro 'suffix' deve existir em _update_multiselect_button"

        # Verificar valor padrao
        assert sig.parameters['suffix'].default == "", "Parametro 'suffix' deve ter default ''"
