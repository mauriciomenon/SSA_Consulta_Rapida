...
from utils.robust_logging import (
    RobustLogger, JSONFormatter, ContextFilter, 
    PerformanceMetrics, get_robust_logger
)
...
class TestRobustLogging(unittest.TestCase):
    ...
    def test_get_robust_logger_function(self):
        ...
        logger.info("Test message", extra={'component': 'test', 'operation': 'unit_test'})
    ...
    def test_log_files_creation(self):
        ...
        self.assertTrue(len(log_files) > 0 or len(json_files) > 0, 
