...
- [Visao da arquitetura](ARCHITECTURE_OVERVIEW.md)
- [Importacao](ARQUITETURA_IMPORTACAO.md)
- [Atualizacao por SSA](ARCH_DB_UPSERT.md)
- [Integridade](ARCH_VALIDATION_AND_INTEGRITY.md)
- [Carregamento e filtros](ARCH_GUI_LOAD_AND_FILTER.md)
- [Preferencias da GUI](GUI_MAIN_PREFERENCES_STRUCTURE.md)
