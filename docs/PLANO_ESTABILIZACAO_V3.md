...
- PROXIMO: S4b promotion gate (bloquear candidato com erro nao-deterministico; matriz de cenarios; repro IMP-01 e o gabarito); depois S4c-e, S5, S6-S9, S10. S4a FECHADO `ef5c0310`: core/import_outcome.py (ImportStatus 14 estados com normalizacao cancelled_*/desconhecidos; ImportOutcome frozen; primary_database_changed so em updated/updated_partial/derivadas_materialized; get_last_import_outcome thread-safe); _finalize_and_return grava o outcome em TODOS os 10 finais com bool inalterado; 5 testes de contrato + 116 suites vizinhas verdes.
