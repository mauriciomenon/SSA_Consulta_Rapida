...
- PROXIMO: S4c lock/concorrencia (IMP-02: lock da rodada antes de discovery ate pos move/cache, com bloqueio do diff durante a promocao; repro existente); depois S4d-e, S5, S6-S9, S10.
