...
### Regras de interpretacao deste handoff

1. Somente o bloco `CURRENT TRUTH` mais novo no topo e autoritativo.
2. Blocos abaixo do topo sao historicos e nao devem sobrescrever baseline ativo.
3. Em conflito de versao entre blocos, prevalece o topo.
