# activate_env.ps1 - Script de Ativação do Ambiente SSA Consulta Rápida v3.0.6

Write-Host "🚀 SSA Consulta Rápida v3.0.6 - Ativação do Ambiente" -ForegroundColor Cyan
