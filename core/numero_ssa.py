...
def normalize_strict(value) -> str | None:
    ...
    if not text:
        return None
    # 1. Remover separadores neutros permitidos ('-' e espaços). Mantém política rígida contra letras e outros símbolos.
    #    Isso evita rejeitar valores como "2025-00777" ou "2025 00777" que historicamente apareciam.
    #    Não aceitamos outros caracteres (pontos, barras, etc.).
