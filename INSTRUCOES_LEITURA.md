INSTRUCOES DE LEITURA DA DOCUMENTACAO (PONTEIRO)

Este arquivo raiz estava vazio. O conteúdo oficial estava em `docs/INSTRUCOES_LEITURA.md`.
Mantemos agora o mesmo texto aqui para evitar abrir aba vazia no VS Code.
Caso haja divergência futura, considerar manter apenas um (preferencialmente o de `docs/`).
...
- Itens uteis:
	...
	- `docs/CHANGELOG_IMPLEMENTACOES.md`: historico tecnico
